 ...
 */
 ...
 public class MethodsLab {
    public static void main(String[] args) {
        ...
        System.out.println("valueOf() vs new Integer()");
        valueVsNew();
    }
    ...
    public static void valueVsNew() {
        Integer a = Integer.valueOf(100); // Uses cached Integer
        Integer b = Integer.valueOf(100); // Points to same cached Integer
        Integer c = new Integer(100); // Creates new Integer instance

        System.out.println("a == b: " + (a == b)); // true, same object due to caching
        System.out.println("a == c: " + (a == c)); // false, different objects
        System.out.println("a.equals(c): " + a.equals(c)); // true, values are the same
    }
}
